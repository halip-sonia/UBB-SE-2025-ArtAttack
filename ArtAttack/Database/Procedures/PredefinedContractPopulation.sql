...
WHEREAS, the Seller desires to sell and the Buyer desires to purchase the product described as {ProductDescription} under the terms and conditions set forth herein;
...
The Seller agrees to sell, and the Buyer agrees to purchase, the product identified as {ProductDescription} for the total sum of {Price}.
...
The Borrower agrees to borrow the product described as {ProductDescription} for a period of {LoanPeriod} days, with a due date of {DueDate}.
