...
namespace ArtAttack.Model
{
    public class DummyProductModel
    {
        ...
        public void AddDummyProduct(float price, int sellerId, DateTime startDate, DateTime endDate)
        {
        ...
        /// </summary>
        public void UpdateDummyProduct(int id, float price, int sellerId, DateTime startDate, DateTime endDate)
        {
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
